  ...
  final Map<String, _i3.PageFactory> pagesMap = {
    AdviceTabRoute.name: (routeData) {
      return _i3.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i1.AdviceTabPage());
    },
    AdviceEditRoute.name: (routeData) {
      ...
      return _i3.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i2.AdviceEditPage(advice: args.advice, key: args.key));
    }
  };

  @override
  List<_i3.RouteConfig> get routes => [
        _i3.RouteConfig(AdviceTabRoute.name, path: '/'),
        _i3.RouteConfig(AdviceEditRoute.name, path: '/adviceEdit')
      ];
}

/// generated route for [_i1.AdviceTabPage]
class AdviceTabRoute extends _i3.PageRouteInfo<void> {
  const AdviceTabRoute() : super(name, path: '/');

  static const String name = 'AdviceTabRoute';
}

/// generated route for [_i2.AdviceEditPage]
class AdviceEditRoute extends _i3.PageRouteInfo<AdviceEditRouteArgs> {
  AdviceEditRoute({_i5.Advice? advice, _i4.Key? key})
      : super(name,
            path: '/adviceEdit',
            args: AdviceEditRouteArgs(advice: advice, key: key));

  static const String name = 'AdviceEditRoute';
}

class AdviceEditRouteArgs {
  const AdviceEditRouteArgs({this.advice, this.key});
